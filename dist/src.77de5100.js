...
},{}],"../Hotkeys.vue":[function(require,module,exports) {
"use strict";
...
exports.default = {
  ...
  methods: {
     ...
     */
    onUseKeyboardShortcuts: function onUseKeyboardShortcuts(evt) {
      var key = evt.keyCode || evt.which;
      var ctr = window.navigator.platform.match('Mac') ? evt.metaKey : evt.ctrlKey;
      var isKeySupported = this.supportedShortcuts.some(function (_a) {
      ...
      /* CTRL | CMD */
      && isKeySupported) {
        var keyString = this.supportedShortcuts.find(function (_a) {
          var keyCode = _a.keyCode;
          return keyCode === key;
        }).keyString;
  ...
  beforeDestroy: function beforeDestroy() {
    ...
    if (this.debug) {
      console.log('Vue Keyboard Shortcuts DISABLED');
        ...
        var $af62e9 = exports.default || module.exports;
      
      if (typeof $af62e9 === 'function') {
        $af62e9 = $af62e9.options;
      }
    
        /* template */
        Object.assign($af62e9, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$af62e9', $af62e9);
          } else {
            api.reload('$af62e9', $af62e9);
          }
        }
...
var Hotkeys_vue_1 = __importDefault(require("../Hotkeys.vue"));

new vue_js_1.default({
  el: '#app',
  components: {
    Hotkeys: Hotkeys_vue_1.default
  },
  template: '\
      <div >\
        <hotkeys \
    ...
    ',
  methods: {
    onTriggeredEventHandler: function onTriggeredEventHandler(payload) {
...
},{"vue/dist/vue.js":"../node_modules/vue/dist/vue.js","../Hotkeys.vue":"../Hotkeys.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
